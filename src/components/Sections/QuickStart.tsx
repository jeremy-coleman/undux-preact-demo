...
import QuickStartStep1 from './markdown/QuickStartStep1.md';
import QuickStartStep2 from './markdown/QuickStartStep2.md';
import QuickStartStep3 from './markdown/QuickStartStep3.md';
import QuickStartStep4 from './markdown/QuickStartStep4.md';
...
import { FlashyHeading } from './parts/FlashyHeading';
...
export function QuickStart() {
  ...
  return <Fragment>
    ...
    <p>When your store updates, Undux will automatically re-render any Preact components that use that store. If you want to do something more complex when a field on the store updates — things like sending AJAX requests, logging, or updating another field on the store — use effects.</p>
    ...
    <SectionSubheading href='quick-start/3'>3. Connect your Preact components</SectionSubheading>
    <p>Once you've created a store and hooked up some effects, it's time to connect your store to a Preact component. You can connect your store to as many Preact components as you want. Every time you connect a component with the <InlineCode>withStore</InlineCode> function, Undux will:</p>
    <ul>
      <li>Automatically re-render your component whenever your store updates.</li>
      <li>Pass your store to your component as a Preact prop, so it's available as <InlineCode>props.store</InlineCode>.</li>
    </ul>
    <p>If you're using <a href='https://preactjs.com'>Preact Hooks</a>, use Undux's <InlineCode>useStore</InlineCode> API instead of <InlineCode>withStore</InlineCode>. Like <InlineCode>withStore</InlineCode>, <InlineCode>useStore</InlineCode> will automatically re-render your component any time your store updates.</p>
