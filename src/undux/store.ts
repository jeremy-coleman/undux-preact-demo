...
/**
 * @internal Use `createConnectedStore` instead.
 */
 ...
 */
export type Plugin<State extends object> = (store: StoreDefinition<State>) => StoreDefinition<State>

export type Effects<State extends object> = (store: StoreDefinition<State>) => StoreDefinition<State>
